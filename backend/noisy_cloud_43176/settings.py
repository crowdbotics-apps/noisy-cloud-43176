"""
Django settings for noisy_cloud_43176 project.
...
ROOT_URLCONF = 'noisy_cloud_43176.urls'
...
WSGI_APPLICATION = 'noisy_cloud_43176.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_cloud_43176 API",
    "DESCRIPTION": "API documentation for noisy_cloud_43176 App",
    "VERSION": "v1",
}
